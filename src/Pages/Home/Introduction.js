        ...
        <section id='introduction' className='lg:mt-28 md:mt-28 mt-24 mb-28'>
            <div className="hero-content flex-col lg:flex-row-reverse" >
                <div>
                    ...
                    <a className="btn rounded-xs border-primary text-primary px-10 capitalize text-md mt-14 hover:bg-primary hover:opacity-70 hover:text-black" href='https://drive.google.com/file/d/1r77NBlzi2QWCbmLTSJPH-V0O52Z1m1a0/view?usp=share_link' target='_blank' rel="noreferrer" > Download My Resume</a >
                </div >
            </div >
        </section >
    );
